...
export const getUserUpdateAsync = () => async (dispatch) => {
  ...
  if (idToken) {
    ...
    const responce = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyBIXaa2NpsPsnzsDgwFHU6zfbP1klBlgAc', requestOptions).then(res => res.json());
